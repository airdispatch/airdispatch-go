...
// source: airdispatch/Message.proto
// DO NOT EDIT!
...
type Alert struct {
	...
	UpdateAlert      *bool   `protobuf:"varint,4,opt,name=update_alert" json:"update_alert,omitempty"`
	UpdateMessageId  *string `protobuf:"bytes,5,opt,name=update_message_id" json:"update_message_id,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *Alert) GetUpdateAlert() bool {
	if m != nil && m.UpdateAlert != nil {
		return *m.UpdateAlert
	}
	return false
}

func (m *Alert) GetUpdateMessageId() string {
	if m != nil && m.UpdateMessageId != nil {
		return *m.UpdateMessageId
	}
	return ""
}
